...
void tipTree::initTipTree() {
  ...
  tipTree::mapData.insert({"bugprone-use-after-move",
  ...
  tipTree::mapData.insert({"bugprone-suspicious-missing-comma",
  ...
  tipTree::mapData.insert({"modernize-use-nullptr",
                           "NULL или 0 → nullptr\n"
                           "nullptr — типизирован, не конфликтует с int, "
                           "безопаснее в перегрузках."});
  tipTree::mapData.insert({"modernize-use-override",
  ...
  tipTree::mapData.insert(
      {"modernize-loop-convert", "Ручной цикл по индексам (for (i=0; i<n; i++))\n"
  ...
  tipTree::mapData.insert(
      {"modernize-make-shared", "new внутри std::shared_ptr<T>(...)\n"
  ...
  tipTree::mapData.insert(
      {"modernize-use-auto", "Явное указание типа, который очевиден из контекста\n"
  ...
  tipTree::mapData.insert({"readability-function-size",
  ...
  tipTree::mapData.insert({"readability-uppercase-literal-suffix",
  ...
  tipTree::mapData.insert(
      {"performance-for-range-copy", "Range-based for с копированием\n"
  ...
  tipTree::mapData.insert({"performance-unnecessary-copy-initialization",
  ...
  tipTree::mapData.insert({"performance-inefficient-string-concatenation",
  ...
  tipTree::mapData.insert({"misc-unused-parameters",
